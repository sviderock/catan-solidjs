...
export const { dropResources, build, trade, exachange, endTurn, isSetupPhase, lastRoll, roll } =
  createRoot(() => {
    ...
    return { dropResources, build, trade, exachange, endTurn, isSetupPhase, lastRoll, roll };
  });
